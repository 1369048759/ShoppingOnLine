  ...
  $.ajax({
    ...
    success: function(userInfor) {
      if (userInfor.status == 1) {
        uid = userInfor.user_infor.user_id;
        uname = (userInfor.user_infor.user_name || userInfor.user_infor.nickname);
      }
    }
  });
  (function() {
    ...
    sc.src = "https://dl.ntalker.com/js/xn6/ntkfstat.js?siteid=kf_10106";
    document.body.parentNode.appendChild(sc);
  })();
  var goods_id = $("input[name='notice_id']").val();
  goods_id = goods_id ? goods_id : '';
  NTKF_PARAM = {
    siteid: "kf_10106",
    settingid: "kf_10106_1405581500428",
    uid: uid,
    uname: uname,
    ntalkerparam: {　　
      item: {　　
  ...
  var NTKF_PARAM = NTKF_PARAM || {
    siteid: "kf_10106",
    settingid: "kf_10106_1368151120079"
  };
  ...
  (function() {
    ...
    function FixedRight(o) {
      ...
      if (o == undefined || o.obj == undefined) {
        return;
      }
      othis.obj = $(o.obj);
      ...
      show: function() {
        ...
        if ($.browser.msie && Number($.browser.version) <= 6) {
          ...
          othis.obj.css({
            "position": "fixed",
            "top": "50%",
            "marginTop": -parseInt(othis.height / 2)
          });
        }
      }
    };
    var fixright = new FixedRight({
      obj: "#Jservice"
    });
    ...
    // ntkf.setAttribute('src', "https://download.ntalker.com/t2dm/ntkfstat.js");
