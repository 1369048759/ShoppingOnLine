...
$wrapper.css('display','');var $titleWrapper=$('<ul><li></li><li>关闭</li></ul>').addClass(opts.titleWrapperClass).appendTo($wrapper);var $titleLi=$("li:first",$titleWrapper).html(opts.title).addClass(opts.titleClass);var $closeLi=$titleLi.next().addClass(opts.closeClass).mousedown(closeMe)
if(opts.closeImg!='')
